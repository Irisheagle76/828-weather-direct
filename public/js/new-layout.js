...
import { getWeatherForUI } from '/js/adapters/weather-adapter.js?v=20260505-precipvoice';
import { calculateComfort } from '/js/intel/comfort.js';
import { generateNarrative } from '/js/intel/synthesizer/index.js?v=20260505-precipvoice';
import { buildHumanActionIntelFS } from '/js/intel/human-action-feelscore.js?v=20260505-precipvoice';

import { renderPulseV2 } from '/js/modules/renderPulseV2.js';
import { renderSubstackV2 } from '/js/modules/renderSubstackV2.js';

console.log("828 Weather layout version: 20260505-precipvoice");
