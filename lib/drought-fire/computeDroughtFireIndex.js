console.log("🔥 compute file loaded");
...
import { buildFireDriver } from "../../src/utils/fire.js"; // 👈 NEW
...
console.log("DEBUG INPUT:", {
  drought: result.DSS,
  wind: weatherInput.windGust,
  humidity: weatherInput.rh
});
...
async function tryFetchSoil(date) {
  try {
    ...
    if (!contentType || !contentType.includes("tiff")) return null;
