...
export async function computeDroughtFireIndexLive(weatherInput = {}) {
 ...
 const fireDriver = buildFireDriver({
  ...
  rainTodayIn: weatherInput.rainTodayIn,
  rainRateInHr: weatherInput.rainRateInHr,
  rainNext6hIn: weatherInput.rainNext6hIn,
  precipProbabilityToday: weatherInput.precipProbabilityToday
});
