...
const CAMERA_URL = "https://i.ytimg.com/vi/UxUU3Fc1vBw/maxresdefault_live.jpg";
...
function analyzeFrame({ width, height, data }) {
  ...
  const skyBottom = Math.floor(height * 0.48);
