...
const PINNED_EAST_LIVE_VIDEO_ID = "_z6EElKOyPU";
...
export default async function handler(req, res) {
  ...
  try {
    let resolved = VIDEO_ID_PATTERN.test(PINNED_EAST_LIVE_VIDEO_ID) ? {
      videoId: PINNED_EAST_LIVE_VIDEO_ID,
      title: "East Asheville Live Stream",
      source: "pinned-east-asheville-live-url"
    } : null;
