...
export const OBSERVATION_STATIONS = Object.freeze([
  ...
  clientraw("saunook", "Saunook", 3317, 35.445883, -83.033635, "Saunook mid-elevation weather reference", "https://www.saunookweather.com/clientraw.txt", {
    destinationId: "waynesville", terrainRole: "western-haywood-mid-elevation", comparisonMethod: "elevation-adjusted", weight: 0.5, sitingConfidence: "medium-low",
    sitingNote: "Local station at 3,317 feet above sea level; useful for the western Haywood elevation profile, with sensor exposure not independently verified."
  }),
...
function clientraw(id, name, elevationFt, latitude, longitude, role, url, fall = null) {
  return Object.freeze({ id, provider: "clientraw", providerStationId: id, name, elevationFt, latitude, longitude, role, url, maxAgeMinutes: 45, fall: freezeFall(fall) });
}
